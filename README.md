...
* **代码授权**：本项目 `v0.1.2` 版本的源代码 [v0.1.2-opensource分支](https://github.com/mtshang/AIDesktopPet/tree/v0.1.2-opensource) 中基于 [MIT License](https://github.com/mtshang/AIDesktopPet/blob/v0.1.2-opensource/LICENSE) 彻底开源。您可以自由学习、修改和分发。
